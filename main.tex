...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\include{contents/trang_bia}
\tableofcontents
\include{contents/bang_danh_gia_thanh_vien}
\include{contents/danh_sach}
\include{contents/loi_mo_dau}
\include{contents/gioi_thieu_chung}
% \include{contents/a}
\include{contents/thuc_hanh_chung}
\include{contents/thuc_hanh_nhom}
\include{contents/ket_luan}
\include{contents/tai_lieu_tham_khao}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\end{document}
