...
% Thực hiện phép nhân ma trận với vector bằng cách sử dụng chương trình Python. Đầu vào của bạn bao gồm một ma trận \(A\) kích thước \(m \times n\) và một vector \(v\) kích thước \(n\). Kết quả của phép nhân là một vector \(u\) kích thước \(m\).
